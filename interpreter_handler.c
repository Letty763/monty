 ...
 * interpreter - this will handle the commands that it reads from the file
 ...
 * opHandler - this will take care of the opcode functions

 * @data: this is the processed information

 * @lnum: the number of the line of code
